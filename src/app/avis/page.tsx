...
const avis = [
  ...
  },
  {
    ...
    note: 5,
    produit: "MyRecup Peanut Roller",
    date: "il y a 1 semaine",
    texte: "J'avais très mal au dos depuis des années à cause du bureau. Une amie m'a conseillé la balle cacahuète. Après 3 semaines à l'utiliser contre le mur chaque soir, les douleurs lombaires ont clairement diminué. Simple, efficace, pas cher — ça fait le taf.",
    utile: 22,
    couleur: "#1A9ED4",
  },
  {
  ...
  },
  {
    ...
    texte: "Le foam roller est de bonne qualité, la surface texturée est vraiment efficace sur les cuisses après le sport. Je l'utilise systématiquement après mes séances de running. J'enlève une étoile parce que j'aurais aimé une housse de transport incluse. Le produit en lui-même est top.",
    utile: 8,
    couleur: "#1A9ED4",
  },
  {
  ...
  },
  {
    ...
    note: 4,
    produit: "MyRecup Vibro Ball",
    date: "il y a 5 semaines",
    texte: "Reçu rapidement, bien emballé. La balle vibrante est top pour cibler la voûte plantaire et les fessiers, zones difficiles d'accès avec un pistolet classique. Je l'utilise 15-20 min après les séances. Vraiment utile en complément du Gun Pro.",
    utile: 15,
    couleur: "#E84525",
  },
  {
