  ...
  return (
    <>
      ...
      <section style={{ background: CREAM, padding: "5rem 2rem 4rem", textAlign: "center" }}>
        <div style={{ width: 80, height: 80, background: "#2a7a2a", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "2.5rem", marginBottom: "2rem", margin: "0 auto 2rem", color: "white", fontWeight: 900 }}>
          ✓
        </div>
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "3rem 2rem" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap", justifyContent: "center" }}>
          <Link
            href="/"
            style={{ ...condensed, display: "inline-block", padding: "1rem 2.5rem", background: ORANGE, color: "white", textDecoration: "none", fontSize: "1rem" }}
          >
            Retour à l'accueil
          </Link>
          <Link
            href="/comparatif"
            style={{ ...condensed, display: "inline-block", padding: "1rem 2.5rem", border: `2px solid ${BLACK}`, color: BLACK, textDecoration: "none", fontSize: "1rem" }}
          >
        ...
        <p style={{ color: "#aaa", fontSize: "0.8rem", textAlign: "center", marginTop: "2rem", lineHeight: 1.6 }}>
          ...
          <Link href="/contact" style={{ color: ORANGE, textDecoration: "underline" }}>
            Contactez-nous
          </Link>
          {" "}— réponse sous 48h.
        </p>
